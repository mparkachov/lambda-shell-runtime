...
LSR_BUCKET_NAME_DEV=${LSR_BUCKET_NAME_DEV:-$LSR_BUCKET_NAME_PROD}

LSR_STACK_NAME_PROD=${LSR_STACK_NAME:-lambda-shell-runtime-setup}
LSR_STACK_NAME_DEV=${LSR_STACK_NAME_DEV:-$LSR_STACK_NAME_PROD}
...
if [ "$LSR_ENV" = "dev" ]; then
  ...
  LSR_SAR_VERSION=$LSR_SAR_VERSION_DEV
else
